...
*/
	...
	.align	2
	.global blvm_secp256k1_fe_mul_inner
	.type	blvm_secp256k1_fe_mul_inner, %function
	.hidden blvm_secp256k1_fe_mul_inner
	@ Arguments:
...
blvm_secp256k1_fe_mul_inner:
	...
	*/
	...
	.size	blvm_secp256k1_fe_mul_inner, .-blvm_secp256k1_fe_mul_inner

	.align	2
	.global blvm_secp256k1_fe_sqr_inner
	.type	blvm_secp256k1_fe_sqr_inner, %function
	.hidden blvm_secp256k1_fe_sqr_inner
	@ Arguments:
...
blvm_secp256k1_fe_sqr_inner:
	...
	*/
	...
	add	sp, sp, #48
	ldmfd	sp!, {r4, r5, r6, r7, r8, r9, r10, r11, pc}
	.size	blvm_secp256k1_fe_sqr_inner, .-blvm_secp256k1_fe_sqr_inner
